  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6 ">
      <div className="lg:flex-1 flex flow-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px] ">
        ...
        />
        <div className="w-[72px] h-full rounded-[20px] bg-[#4cad8d] flex justify-center items-center cursor-pointer ">
          <img
            src={search}
            alt="search"
      ...
      <div className="sm:hidden flex justify-between items-center relative ">
        ...
        <img
          src={menu}
          alt="menu"
          className="w-[34px] h-3[34p] object-contain cursor-pointer "
